...
from .views import index, qualification_dashboard,create_qualification,update_qualification,delete_qualification,position_dashboard,create_position,update_position,delete_position
urlpatterns = [
